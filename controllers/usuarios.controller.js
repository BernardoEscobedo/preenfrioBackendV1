...
// Supervisores y operativos sin zona de trabajo: no ven ningún dato.
// Conviene revisarlo después de dar de alta personal.
...
// No toca la contraseña ni la zona de trabajo: cada una tiene su endpoint.
...
const deleteUsuario = async (req, res) => {
    try {
        ...
        if (error.code === "23503") {
            return res.status(409).json({
                error: "No se puede eliminar: el usuario tiene registros asociados (recepciones, movimientos o evidencias)"
            });
        }
